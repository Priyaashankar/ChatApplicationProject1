...
public class chat_client extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(chat_client.class.getName()).log(java.util.logging.Level.SEVERE, null,
                    ex);
        ...
        try {
            ...
            s = new Socket("127.0.0.1", 1201); // ip address is of localhost because server is running on the same
                                               // mschine
